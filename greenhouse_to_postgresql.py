...
import funcs_job_tables as fjt
...
fjt.Clear_Job_Tables()
fjt.Init_Job_Tables()

def Load_Greenhouse_Jobs():
       ...
       for company in companies:
          ...
          for posting in jobs_list:
             ...
             try:
                ...
                cur.execute(add_job , (gj_id, ij_id, curr_company_id,
                                       job_title, loc, posted, updated, url))
             ...
             #
             # This section is meant to parse the meaty parts of the job posting
             # for more useful information to be found regarding job qualifications,
             # salary, benefits, etc
             #
             #
             ####################################
